...
const analyzeWithGroq = async (text) => {
    ...
    CRITICAL INSTRUCTION FOR EDUCATION:
    - "qualification" field MUST ONLY contain Post-Graduate degrees (e.g., MBA, M.Tech, MSc, MA, PGDM, PhD). If the candidate only has a Bachelors, leave this BLANK or null.
    - "graduation" field MUST contain the Undergraduate/Bachelors degree (e.g., B.Tech, B.E, B.Com, BSc, BCA, BBA).
    - Do NOT put the Bachelors degree in the "qualification" field.
    ...
    FIELDS TO EXTRACT:
    {
      ...
      "qualification": "Masters / PG / Professional Cert ONLY (e.g. MBA, M.Tech). Leave empty if none.",
      "graduation": "Bachelors / Graduation ONLY (e.g. B.Tech, B.Com).",
